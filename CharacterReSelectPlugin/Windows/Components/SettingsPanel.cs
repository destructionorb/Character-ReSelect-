...
using CharacterReSelectPlugin.Managers;
using System.IO;
using System.Windows.Forms;
using System.Threading;

namespace CharacterReSelectPlugin.Windows.Components
{
    public class SettingsPanel : IDisposable
    {
        ...
        private void DrawCharacterAssignmentSettings()
        {
            ...
            if (Plugin.RePlayerState.IsLoaded && Plugin.RePlayerState != null)
            {
                var player = Plugin.RePlayerState;
                if (player.HomeWorld.IsValid)
                {
                    string currentFormat = $"{player.CharacterName}@{player.HomeWorld.Value.Name}";
